...
if [ $stage -le 2 ]; then 
  ...
  python gen_train_dev_test.py ${datadir}/noise/all/6mic_diffuse_noise/diffuse_noise.scp 90.0:5.0:5.0 ${datadir}/noise/6mic_diffuse_noise/ || exit 1;
fi
...
num_null=0
num_mic=6
targ_bf=/exdata/HOME/snie/DeepNoiseTrackingNetwork/train_enhance_cfeat/egs/6mic/exp/bf_targ_bf_6mic_3.5cm.mat
