...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--exp_path', default='exp', type=str, help='exp_path')
        ...
        self.parser.add_argument('--thread_num', default='0', type=str, help='thread_num')
        ...
        self.parser.add_argument('--num_workers', default=2, type=int, help='Number of workers used in data-loading')
        ...
        self.parser.add_argument('--smoothing', type=float, default=0.2, help='smoothing')
        
        # augment (parameter) related        
        self.parser.add_argument('--agument_feat', default=False, action='store_true', help='agument_feat')
        self.parser.add_argument('--augment_w_para', default=80, type=int, help='augment_w_para')
        self.parser.add_argument('--augment_f_para', default=15, type=int, help='augment_f_para')
        self.parser.add_argument('--augment_f_num', default=1, type=int, help='augment_f_num')
        self.parser.add_argument('--augment_t_para', default=50, type=int, help='augment_t_para')
        self.parser.add_argument('--augment_t_num', default=1, type=int, help='augment_t_num')
        self.parser.add_argument('--augment_p_para', default=1.0, type=float, help='augment_p_para')
        ...
        self.parser.add_argument('--rnn_hidden_size', type=int, default=256, help='rnn_hidden_size')
        ...
        self.parser.add_argument('--embedding_loss_lamda', type=float, default=1.0, help='embedding_loss_lamda')
        self.parser.add_argument('--class_loss_lamda', type=float, default=1.0, help='class_loss_lamda')
        ...
        self.parser.add_argument('--margin_s', type=float, default=32.0, help='margin_s')
        self.parser.add_argument('--margin_m', type=float, default=0.2, help='margin_m')
        ...
        self.parser.add_argument('--resume_1', default='', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')    
        self.parser.add_argument('--resume_2', default='', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')     

        self.parser.add_argument('--validate_freq', type=int, default=5000, help='how many batches to validate the trained model')  
